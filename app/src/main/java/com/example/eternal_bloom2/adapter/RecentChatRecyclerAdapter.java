package com.example.eternal_bloom2.adapter;
...
import com.example.eternal_bloom2.ChatActivity;
import com.example.eternal_bloom2.R;
...
//                        if (currentUserModel != null && currentUserModel.getProfessional()) {
